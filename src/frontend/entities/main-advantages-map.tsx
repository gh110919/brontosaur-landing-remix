...
const CardText = styled.p`
  ...
  @media (max-width: 48rem) {
    width: calc(592 * var(--mv));
    height: calc(48 * var(--mv));
    font-size: calc(18 * var(--mv));
    line-height: calc(24 * var(--mv));
  }
`;

export const MainAdvantagesMap = () => {
  return (
    <Container>
      <AdvantagesList>
        {data.main_advantages.map((e, i) => {
          return (
            <li key={i}>
              <Card>
                <TitleImageBox>
